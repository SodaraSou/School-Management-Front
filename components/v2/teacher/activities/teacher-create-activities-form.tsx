...
import { createActivity } from "@/app/v2/(dashboard)/@teacher/activities/actions";
...
export default function TeacherCreateActivitiesForm({
  activityTypeId,
  groupId,
  teacherGroups,
  activitiesType,
  ...
  const [groups, setGroups] = useState(groupId ? [Number(groupId)] : []);
