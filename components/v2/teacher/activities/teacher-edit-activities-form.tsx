...
//   },
//   {
//     name: "Which one is a correct syntax?",
//     type: "single_choice",
//     is_require: true,
//     correct_answer: "Option 2",
//     points: 10,
//     options: [
//       { name: "Option 1", is_correct: false },
//       { name: "Option 2", is_correct: true },
//       { name: "Option 3", is_correct: false },
//     ],
//   },
//   {
//     name: "Select all state management libraries:",
//     type: "multiple_choice",
//     is_require: true,
//     correct_answer: "Redux, MobX",
//     points: 15,
//     options: [
//       { name: "Redux", is_correct: true },
//       { name: "MobX", is_correct: true },
//       { name: "Express", is_correct: false },
//     ],
//   },
// ];

// export default function TeacherEditActivitiesFormV2() {
...
//         <CardTitle className="text-3xl font-semibold text-indigo-900">
//           Edit Activities
//         </CardTitle>
//       </CardHeader>
...
//               {/* Options for single_choice and multiple_choice types */}
...
//           <Button
//             variant="ghost"
//             className="hover:bg-indigo-100 hover:underline"
//             type="submit"
//           >
//             Save Changes
//           </Button>
...
export default function TeacherEditActivitiesForm({
  ...
  // Prepopulate with the existing activity values
  ...
  const [questions, setQuestions] = useState<Question[]>(
    activity.questions.length ? activity.questions : [
      {
        name: "",
        type: "text",
        is_require: false,
  ...
  const [groups, setGroups] = useState(activity.groups);
      ...
      <CardContent className="p-6 flex flex-col gap-6">
        <div className="flex justify-between items-center">
          ...
          <TeacherAssignActivitiesDialog
            ...
            defaultGroupId={groups[0]?.toString()}
          />
        </div>
        <div>
          <label className="block mb-1 font-medium">Activity Type:</label>
